...
// Sau 1.5 giây tự gọi onFinish() để chuyển sang route chính.
// onFinish nhận bool isAuthenticated để điều hướng đúng chỗ.
...
class SplashScreen extends StatefulWidget {
  /// Gọi khi animation xong. [isAuthenticated] = true nếu user đã đăng nhập.
  final void Function(bool isAuthenticated) onFinish;
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    _fadeCtrl.forward().whenComplete(() {
      if (mounted) widget.onFinish(widget.isAuthenticated);
    });
  }
